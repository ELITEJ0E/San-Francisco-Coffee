...
export const DEFAULT_OUTLETS: Outlet[] = [
  {
    id: 1,
    name: "Suria KLCC",
    address: "Ampang Mall, Suria KLCC",
  ...
  },
  {
    ...
    address: "Speaker's Corner, Enterprise 4, Technology Park Malaysia",
    hours: "10.00 am - 10.00 pm",
    phone: "+603-8966 2547",
    isOpen: true,
    distance: "1.4 km",
  ...
  },
  {
    ...
    address: "GF-12, Ground Floor, Bangsar Village II, Jalan Telawi 1",
    hours: "10.00 am - 10.00 pm",
    phone: "+603-8966 2547",
    isOpen: true,
    distance: "3.8 km",
